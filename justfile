...
preflight:
    ...
    $failed = $false
    Write-Host "=========================================="
    Write-Host "  DCode Build Preflight Check"
    Write-Host "=========================================="
    Write-Host ""
...
build-win: preflight
    ...
    Get-Process -Name "DCode","electron" -ErrorAction SilentlyContinue | Stop-Process -Force -ErrorAction SilentlyContinue
