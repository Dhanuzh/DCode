...
function getLogFilePath(): string {
  ...
  // Dev mode uses "DCode-Dev", production uses "DCode"
  const devPath = path.join(os.homedir(), 'Library', 'Logs', 'DCode-Dev', `${today}.log`);
  const prodPath = path.join(os.homedir(), 'Library', 'Logs', 'DCode', `${today}.log`);
