...
const { verifyBundledAioncoreResources } = require('../packages/shared-scripts/src/verify-bundled-dcode-core-resources');
...
function resolveResourcesDir(electronPlatformName, appOutDir, packager) {
  ...
  const appName = packager?.appInfo?.productFilename || 'DCode';
