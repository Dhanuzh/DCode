<p align="center">
  <img src="../../resources/aionui-banner-1.png" alt="DCode - Спільна робота з AI-агентами" width="100%">
</p>
...
<p align="center">
  <strong>💬 Спільнота:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-19.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/AionUI" target="_blank">Twitter</a>
</p>
...
<p align="center">
  <a href="https://x.com/AionUi/status/2079493379914961069">
    <img src="../../resources/kimi/contributor-bonus-black-blue.jpg" alt="DCode × Kimi Бонус для контриб’юторів" width="600">
  </a>
</p>

<p align="center">
  🎁 <strong>Партнерство DCode × Kimi</strong>: безкоштовні преміум-плани <strong>Kimi «Allegretto» (вартістю $39/міс · ¥199/міс)</strong> для наших контриб’юторів!
</p>
...
[🤔 Чому варто обрати DCode?](#-чому-варто-обрати-dcode-замість-claude-cowork) ·
...
**DCode — це більше, ніж просто чат-клієнт.** Це платформа для спільної роботи (Cowork), де AI-агенти працюють пліч-о-пліч із вами на вашому комп'ютері: читають файли, пишуть код, шукають в інтернеті та автоматизують завдання. Ви бачите все, що робить агент, і завжди зберігаєте контроль.

|                                    | Традиційні AI чат-клієнти | **DCode (Cowork)**                                                                                                     |
| :--------------------------------- | :------------------------ | :---------------------------------------------------------------------------------------------------------------------- |
...
DCode постачається з повноцінним рушієм AI-агентів. На відміну від інструментів, що вимагають окремого встановлення CLI-агентів, **DCode працює одразу після встановлення**.
...
Якщо ви вже використовуєте Claude Code, Codex, Hermes Agent або OpenClaw, DCode автоматично виявить їх і дозволить працювати з усіма ними разом із вбудованим агентом.
...
- **Єдине керування MCP** — керуйте MCP-інструментами в одному місці; DCode додає або синхронізує сумісні транспорти відповідно до можливостей кожного агента
...
- **Паралельне виконання кількох агентів** — Leader ділить і делегує завдання Teammate-агентам; зовнішні агенти підключаються через ACP (Agent Client Protocol), а DCode координує команду
...
Інші додатки дають лише вікно чату. **DCode дає повноцінного агента для спільної роботи.**
...
Ті ж самі можливості — читання/запис файлів, веб-пошук, генерація зображень — незалежно від того, яка модель використовується. DCode підтримує **30+ AI-платформ**.
...
- **Трирівневі навички** — вбудовані навички (поставляються з DCode), власні навички (ваші особисті) та Extension-навички (від сторонніх розширень); вмикайте/вимикайте для кожної розмови з індикатором навичок
...
- **🧭 DCode Butler** — Поради щодо продукту, допомога з налаштуванням і усунення несправностей в DCode
...
> 💡 Канонічні вбудовані визначення містяться в [каталозі асистентів](https://github.com/iOfficeAI/AionCore/blob/main/crates/aionui-app/assets/builtin-assistants/assistants.json) AionCore. Правила залишаються у Markdown і налаштовуються в DCode.
...
- **Режим без сну** — DCode автоматично запобігає переходу системи у сплячий режим, поки активні завдання, та визначає пропущені тригери після пробудження
...
## 🤔 Чому варто обрати DCode замість Claude Cowork?

DCode — це **безкоштовний Multi-AI Agent десктоп**. На відміну від Claude Cowork, який працює лише на macOS і обмежений лише Claude, DCode — це версія з підтримкою всіх моделей та платформ.
...
Локальна розробка DCode використовує два репозиторії: AionUi для Electron-фронтенду та AionCore для локального backend. Повні інструкції для macOS, Linux і Windows наведені в [Development Guide](../contributing/development.md).
