  ...
  void import('@sentry/electron/renderer')
    .then((Sentry) => {
      Sentry.withScope((scope) => {
        scope.setTag('dcode.installation_integrity', event.failure_kind ?? 'unknown');
        scope.setTag('dcode.runtime_resource', event.resource);
        scope.setTag('dcode.runtime_resource_id', event.resource_id ?? '');
        scope.setTag('dcode.runtime_scope', event.scope.kind);
