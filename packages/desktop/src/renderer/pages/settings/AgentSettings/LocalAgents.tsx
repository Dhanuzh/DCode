...
// TODO: point at DCode's own setup docs once published; placeholder for now.
const LOCAL_AGENT_SETUP_GUIDE_URL = 'https://dcodes.site';
...
const LocalAgents: React.FC = () => {
  ...
  //
  // Temporarily limited to DCode CLI only (the one agent that reads from the
  // Google Cloud Vertex AI provider) — other CLI agents are still fully
  // detected/usable, just hidden from this list for now. Remove the
  // `agent_type === 'aionrs'` clause below to restore the full list.
