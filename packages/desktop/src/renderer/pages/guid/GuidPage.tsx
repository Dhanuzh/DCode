...
const GuidPage: React.FC = () => {
  ...
  // Temporarily limited to the Google Cloud Vertex assistant only — the other
  // preset assistants are still fully usable elsewhere (Settings → Assistants,
  // conversation continuation), just hidden from this home-screen picker for
  // now. Remove this .filter(...) to restore the full assistant bar.
  const homeAssistants = useMemo(
    () => agentSelection.assistants.filter((assistant) => isAionrsAssistant(assistant)),
