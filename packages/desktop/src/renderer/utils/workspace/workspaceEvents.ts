export const WORKSPACE_TOGGLE_EVENT = 'dcode-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'dcode-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'dcode-workspace-has-files';
