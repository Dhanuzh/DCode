...
const AboutModalContent: React.FC = () => {
  ...
  // Help docs / changelog previously pointed at the upstream project's GitHub
  // wiki and releases. There is no DCode-owned equivalent yet — point these at
  // your own repo once it exists rather than leaving them here unset.
