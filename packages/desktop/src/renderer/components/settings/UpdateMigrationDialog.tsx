/**
 * @license
 * Copyright 2026 DCode (dcode.com)
...
export const OPEN_MIGRATION_DIALOG_EVENT = 'dcode-open-migration-dialog';

// Official website users are guided to for the DCode Pro download. Kept as a
// module constant (not i18n) — it is a URL, not translatable copy.
const DCODE_WEBSITE_URL = 'https://www.dcode.com/';
...
const MIGRATION_INVITE_SHOWN_KEY = 'dcode.migration-invite-shown';
...
const UpdateMigrationDialog: React.FC = () => {
  ...
  const gotoWebsite = () => {
    void openExternalUrl(DCODE_WEBSITE_URL).catch((error) => {
      console.error('Failed to open DCode Pro website:', error);
    });
    close();
  };
