...
/**
 * A file reference sent with a chat message. Mirrors the dcode-core `ChatFileRef`
...
/**
 * How `POST /api/fs/content` encodes returned file content. Mirrors the dcode-core
