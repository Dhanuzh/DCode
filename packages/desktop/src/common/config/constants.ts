 ...
 */
export const BROWSER_SESSION_PARTITION = 'persist:dcode-browser';
 ...
 */
export const BUILTIN_BROWSER_MCP_NAME = 'dcode-browser';

// ===== 文件处理相关常量 =====

/** 临时文件时间戳分隔符 */
export const DCODE_TIMESTAMP_SEPARATOR = '_dcode_';

/** 用于匹配和清理时间戳后缀的正则表达式 */
export const DCODE_TIMESTAMP_REGEX = /_dcode_\d{13}(\.\w+)?$/;
export const DCODE_FILES_MARKER = '[[DCODE_FILES]]';
