...
export const SINGLE_TARGET_ID = 'dcode-browser-target';
export const SINGLE_SESSION_ID = 'dcode-browser-session';
export const SINGLE_BROWSER_CONTEXT_ID = 'dcode-browser-context';
...
export const buildVersionPayload = (wsUrl: string, chromeVersion: string) => ({
  ...
  'User-Agent': `DCode in-app browser (Chrome/${chromeVersion})`,
...
export const decideCdpCommand = (req: CdpRequest, getTargetInfo: () => TargetInfo): CdpDecision => {
  ...
  switch (method) {
    ...
    case 'Target.createTarget':
      return {
        kind: 'error',
        message: 'DCode in-app browser exposes a single fixed tab; Target.createTarget is not supported.',
      };

    case 'Target.createBrowserContext':
    case 'Target.disposeBrowserContext':
      return { kind: 'error', message: 'DCode in-app browser does not support multiple browser contexts.' };
     ...
     */
    case 'Browser.close':
      return { kind: 'error', message: 'Browser.close is not permitted against the DCode in-app browser.' };
