 ...
 *
 * Only the instance that owns the single-instance lock may spawn dcode-core. A
 * lock-losing instance must never register backend startup; otherwise it races
 * the first instance's dcode-core over the same data directory, which produced
