 ...
 *   - macOS:   ~/Library/Logs/DCode/YYYY/MM/DD/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\DCode\logs\YYYY\MM\DD\YYYY-MM-DD.log
 *   - Linux:   ~/.config/DCode/logs/YYYY/MM/DD/YYYY-MM-DD.log
 *
...
const BACKEND_PREFIX = '[dcode-core]';
