...
export const PROTOCOL_SCHEME = 'dcode';

/**
 * Parse a dcode:// URL into action and params.
 * Supports two formats:
 *   1. dcode://add-provider?base_url=xxx&api_key=xxx
 *   2. dcode://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
